...
const ImGui = __importStar(require("imgui-js"));
const ImGui_Impl = __importStar(require("./imgui_impl.js"));
const imgui_demo_js_1 = require("./imgui_demo.js");
const imgui_memory_editor_js_1 = require("./imgui_memory_editor.js");
let font = null;
// Our state
let show_demo_window = true;
let show_another_window = false;
const clear_color = new ImGui.Vec4(0.45, 0.55, 0.60, 1.00);
const memory_editor = new imgui_memory_editor_js_1.MemoryEditor();
...
function _loop(time) {
    ...
    if (!done && show_demo_window) {
        done = /*ImGui.*/ (0, imgui_demo_js_1.ShowDemoWindow)((value = show_demo_window) => show_demo_window = value);
    }
    ...
    if (gl) {
        ...
        var xd = gl.COLOR_BUFFER_BIT;
        xd |= gl.DEPTH_BUFFER_BIT;
        gl.clear(xd);
